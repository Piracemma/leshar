    ...
    <div>
        ...
        <form>
            ...
            <div>
                ...
                <input type="text" placeholder="E-mail ou Usuario">       
        ...
        <p class="flex justify-center my-3 text-stone-700">----- ou -----</p>

        <div>

            <button wire:click="loginGoogle" class="py-2 px-3 bg-blue-600 rounded-lg flex items-center justify-center w-full">
